object FrmChama_Grupo_Produto_Tributacao_COFINS: TFrmChama_Grupo_Produto_Tributacao_COFINS
  Left = 0
  Top = 0
  ...
  object qrychama_grupo: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select GPTC.*, TC.Descricao from Grupo_Produto_Tributacao_COFINS' +
        ' GPTC'
    ...
    object qrychama_grupoCodigo_Tratamento_COFINS: TIntegerField
      FieldName = 'Codigo_Tratamento_COFINS'
    end
