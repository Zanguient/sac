...
uses UDM, UChama_Cliente, UChama_Etiqueta, URel_Etiqueta, UDeclaracao;
...
begin
  Limpa_Cliente;
  FrmGera_Etiqueta.Free;
  FrmGera_Etiqueta := nil;
end;
...
begin
  ...
  if FileExists('C:\Clientes.xml') then
    ClientDataSet1.LoadFromFile('C:\Clientes.xml');
end;
