unit URel_Consulta_Patrimonio_Tipo;
...
type
  TFrmRel_Consulta_Patrimonio_Tipo = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Patrimonio_Tipo: TFrmRel_Consulta_Patrimonio_Tipo;
...
procedure TFrmRel_Consulta_Patrimonio_Tipo.FormCreate(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Patrimonio_Tipo.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
