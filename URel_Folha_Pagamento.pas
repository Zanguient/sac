...
uses UFolha_Pagamento, UDeclaracao, UGeral;
...
begin
  ...
  QRLabel14.Caption:= FrmFolha_Pagamento.EdtEmpresa.Text;
  ...
  LblCPF.Caption:= cp;
  LblEndereco.Caption:= FrmFolha_Pagamento.LblEndereco.Caption + ', ' + FrmFolha_Pagamento.LblNumero.Caption;
  ...
  LblCNPJ.Caption:= cn;
  LblEndereco_Empresa.Caption:= endereco + ', ' + numero;
  ...
  //LblComissao.Caption:= FrmFolha_Pagamento.EdtComissao.Text;
