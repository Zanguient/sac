object FrmChama_Cidade: TFrmChama_Cidade
  ...
  object qrychama_cidade: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select C.*, P.Descricao as Pais from Cidade C'
      'left join Pais P on (C.Codigo_Pais = P.Codigo)')
    Left = 464
    Top = 272
    object qrychama_cidadeCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object qrychama_cidadeDescricao: TStringField
      FieldName = 'Descricao'
      Size = 30
    end
    ...
    object qrychama_cidadeCodigo_Municipio: TStringField
      FieldName = 'Codigo_Municipio'
    end
    object qrychama_cidadeCodigo_Pais: TIntegerField
      FieldName = 'Codigo_Pais'
    end
    object qrychama_cidadePais: TStringField
      FieldName = 'Pais'
      Size = 100
    end
  end
