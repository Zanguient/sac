object FrmRel_Consulta_Entrada: TFrmRel_Consulta_Entrada
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'ADOQuery1.N_Nota_Fiscal'
      FooterBand = QRBand1
      Master = QuickRep1
    ...
    object QRBand3: TQRBand
      ...
      object QRDBText33: TQRDBText
        ...
        Color = clWhite
        DataSet = ADOQuery1
        DataField = 'Percentual_Lucro_Vista'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object QRDBText35: TQRDBText
        ...
        Color = clWhite
        DataSet = ADOQuery1
        DataField = 'Percentual_Lucro_Prazo'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object QRDBText37: TQRDBText
        ...
        Color = clWhite
        DataSet = ADOQuery1
        DataField = 'Valor_Frete_Unitario'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select EP.*, IE.*, ImpE.*, P.Codigo_Venda, P.Descricao, P.Estoqu' +
        'e, Forn.Nome_Fantasia from Entrada_Produtos EP'
      
        'inner join Impostos_Entrada ImpE on (EP.N_Nota_Fiscal = ImpE.N_N' +
        'ota_Fiscal)'
      
        'inner join Itens_Entrada IE on (EP.N_Nota_Fiscal = IE.N_Nota_Fis' +
        'cal)'
    ...
    object ADOQuery1N_Nota_Fiscal: TStringField
      FieldName = 'N_Nota_Fiscal'
    end
    object ADOQuery1Modelo: TStringField
      FieldName = 'Modelo'
      Size = 10
    end
    object ADOQuery1Serie: TStringField
      FieldName = 'Serie'
      Size = 10
    end
    object ADOQuery1Data_Emissao: TDateTimeField
      FieldName = 'Data_Emissao'
    end
    object ADOQuery1Hora_Emissao: TStringField
    ...
    object ADOQuery1Hora_Entrada: TStringField
    ...
    object ADOQuery1Tipo_Pagamento: TStringField
      FieldName = 'Tipo_Pagamento'
    end
    object ADOQuery1Codigo_Fornecedor: TIntegerField
      FieldName = 'Codigo_Fornecedor'
    end
    object ADOQuery1Codigo_CFOP: TIntegerField
    ...
    object ADOQuery1N_Nota_Fiscal_1: TStringField
    ...
    object ADOQuery1ST: TStringField
      FieldName = 'ST'
      Size = 5
    end
    object ADOQuery1Valor_Ultima_Compra: TFloatField
    ...
    object ADOQuery1Aliquota_ICMS: TStringField
      FieldName = 'Aliquota_ICMS'
      Size = 5
    end
    object ADOQuery1Aliquota_IPI: TStringField
    ...
    object ADOQuery1Codigo_2: TIntegerField
      FieldName = 'Codigo_2'
    end
    object ADOQuery1N_Nota_Fiscal_2: TStringField
      FieldName = 'N_Nota_Fiscal_2'
    end
    ...
    object ADOQuery1Valor_ICMS: TFloatField
      FieldName = 'Valor_ICMS'
    end
    object ADOQuery1Isento_ICMS: TFloatField
      FieldName = 'Isento_ICMS'
    end
    object ADOQuery1Outros_ICMS: TFloatField
      FieldName = 'Outros_ICMS'
    end
    object ADOQuery1Base_ICMS_Subs: TFloatField
      FieldName = 'Base_ICMS_Subs'
    end
    object ADOQuery1Valor_ICMS_Subs: TFloatField
      FieldName = 'Valor_ICMS_Subs'
    end
    object ADOQuery1Aliquota: TFloatField
      FieldName = 'Aliquota'
    end
    ...
    object ADOQuery1Total_IPI: TFloatField
      FieldName = 'Total_IPI'
    end
    object ADOQuery1Isento_IPI: TFloatField
      FieldName = 'Isento_IPI'
    end
    object ADOQuery1Outros_IPI: TFloatField
      FieldName = 'Outros_IPI'
    end
    object ADOQuery1Desconto: TFloatField
      FieldName = 'Desconto'
    end
    object ADOQuery1Total_Nota: TFloatField
    ...
    object ADOQuery1Quantidade_Volume: TFloatField
      FieldName = 'Quantidade_Volume'
    end
    object ADOQuery1Valor_Frete_Unitario: TFloatField
      FieldName = 'Valor_Frete_Unitario'
    end
    object ADOQuery1Percentual_Lucro_Vista: TFloatField
      FieldName = 'Percentual_Lucro_Vista'
    end
    object ADOQuery1Valor_Vista: TFloatField
      FieldName = 'Valor_Vista'
    end
    object ADOQuery1Percentual_Lucro_Prazo: TFloatField
      FieldName = 'Percentual_Lucro_Prazo'
    end
    object ADOQuery1Valor_Prazo: TFloatField
      FieldName = 'Valor_Prazo'
    end
    object ADOQuery1Custo_Unitario: TFloatField
      FieldName = 'Custo_Unitario'
    end
    object ADOQuery1BC_ICMS: TFloatField
      FieldName = 'BC_ICMS'
    end
    object ADOQuery1Valor_ICMS_Unitario: TFloatField
      FieldName = 'Valor_ICMS_Unitario'
    end
    object ADOQuery1IVA: TFloatField
      FieldName = 'IVA'
    end
