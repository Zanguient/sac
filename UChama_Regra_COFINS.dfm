object FrmChama_Regra_Cofins: TFrmChama_Regra_Cofins
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Consulta Regras de COFINS'
  ClientHeight = 553
  ClientWidth = 942
  Color = clWindow
  ...
  object qrychama_regra: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select RC.*, CST.Descricao as Situacao, CST.Codigo_Situacao from' +
        ' Regra_COFINS RC'
      
        'inner join Cadastro_Situacao_Tributaria CST on (RC.Codigo_Situac' +
