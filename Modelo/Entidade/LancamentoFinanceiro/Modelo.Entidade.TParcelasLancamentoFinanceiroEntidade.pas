...
uses
  ...
  type
    ...
    private
      FLancamentoFinanceiro: TLancamentoFinanceiroEntidade;
      FCodigo: integer;
      ...
      FValor_Pagar: double;
      FCodigo_Forma_Pagamento_Parcela: double;
      ...
      procedure SetCodigo_Forma_Pagamento_Parcela(const Value: double);
      ...
      procedure SetLancamentoFinanceiro(const Value: TLancamentoFinanceiroEntidade);
    ...
    public
      property LancamentoFinanceiro: TLancamentoFinanceiroEntidade read FLancamentoFinanceiro write SetLancamentoFinanceiro;
      ...
      property Codigo_Forma_Pagamento_Parcela: double read FCodigo_Forma_Pagamento_Parcela write SetCodigo_Forma_Pagamento_Parcela;
...
procedure TParcelasLancamentoFinanceiroEntidade.SetLancamentoFinanceiro(
  const Value: TLancamentoFinanceiroEntidade);
begin
  FLancamentoFinanceiro := Value;
end;
...
procedure TParcelasLancamentoFinanceiroEntidade.SetStatus(const Value: StatusEnum);
begin
  FStatus := Value;
end;
