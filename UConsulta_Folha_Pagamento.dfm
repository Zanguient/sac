object FrmConsulta_Folha_Pagamento: TFrmConsulta_Folha_Pagamento
  ...
  object EdtCodigo_Empresa: TEdit
    Left = 394
    Top = 38
    Width = 57
    Height = 17
    ...
    ShowHint = True
    TabOrder = 0
    OnKeyDown = EdtCodigo_EmpresaKeyDown
    OnKeyPress = EdtCodigo_FuncionarioKeyPress
  end
  object qryconsulta_folha: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select FP.*, Fun.Nome from Folha_Pagamento FP'
    ...
    object qryconsulta_folhaCodigo_Empresa: TIntegerField
      FieldName = 'Codigo_Empresa'
    end
    ...
    object qryconsulta_folhaComissao: TFloatField
      FieldName = 'Comissao'
      DisplayFormat = '#0.0,0'
    end
