...
procedure TFrmGera_Etiqueta_Produto.EdtCodigo_EtiquetaKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;

procedure TFrmGera_Etiqueta_Produto.EdtCodigo_ProdutoKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (key = vk_f3) then
  begin
...
procedure TFrmGera_Etiqueta_Produto.EdtEtiquetaKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;
...
begin
  Limpa_Cliente;
  FrmGera_Etiqueta_Produto.Free;
  FrmGera_Etiqueta_Produto:= Nil;
end;
...
procedure TFrmGera_Etiqueta_Produto.ToolButton1Click(Sender: TObject);
begin
