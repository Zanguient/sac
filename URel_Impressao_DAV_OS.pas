...
type
  TFrmRel_Impressao_DAV_OS = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Impressao_DAV_OS: TFrmRel_Impressao_DAV_OS;
...
procedure TFrmRel_Impressao_DAV_OS.FormCreate(Sender: TObject);
var
  i: integer;
begin
...
procedure TFrmRel_Impressao_DAV_OS.QRSubDetail1BeforePrint(
...
procedure TFrmRel_Impressao_DAV_OS.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TFrmRel_Impressao_DAV_OS.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
  var
    i: integer;
    texto: string;
