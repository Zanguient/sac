object FrmRel_Consulta_Lancamento_Financeiro: TFrmRel_Consulta_Lancamento_Financeiro
  ...
  object QuickRep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel6: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Consulta por Lan'#231'amento:'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select LF.*, PL.*, CP.Descricao, TD.Descricao, D.Descricao, PF.P' +
        'lano, MC.Dinheiro, MC.Cheque_Vista, MC.Cheque_Prazo, MC.Cartao, ' +
        'MC.Juros, MC.Desconto,'
      'Nome = case when (LF.Tipo = '#39#39') then'
      ...
      'when (LF.Tipo = '#39#39') then'
        ...
        'inner join Parcelas_Lancamentos PL on (LF.N_Documento = PL.N_Doc' +
        'umento)'
