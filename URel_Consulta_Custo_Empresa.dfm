object FrmRel_Consulta_Custo_Empresa: TFrmRel_Consulta_Custo_Empresa
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 533
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.VALORTOTAL)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.VALOR_FIXO)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.VALOR_VARIAVEL)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = '( SUM(ADOQuery1.VALOR_FIXO) /SUM(ADOQuery1.VALORTOTAL))*100'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = '( SUM(ADOQuery1.VALOR_VARIAVEL) /SUM(ADOQuery1.VALORTOTAL))*100'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1VALOR_FIXO: TFloatField
      FieldName = 'VALOR_FIXO'
      ReadOnly = True
      DisplayFormat = '#0.0,0'
    end
    object ADOQuery1VALOR_VARIAVEL: TFloatField
      FieldName = 'VALOR_VARIAVEL'
      ReadOnly = True
      DisplayFormat = '#0.0,0'
    end
    object ADOQuery1VALORTOTAL: TFloatField
      FieldName = 'VALORTOTAL'
      ReadOnly = True
      DisplayFormat = '#0.0,0'
    end
    object ADOQuery1PFIXO: TFloatField
      FieldName = 'PFIXO'
      ReadOnly = True
      DisplayFormat = '#0.0,0'
    end
    object ADOQuery1PVARIAVEL: TFloatField
      FieldName = 'PVARIAVEL'
      ReadOnly = True
      DisplayFormat = '#0.0,0'
    end
