object FrmChama_Tratamento_COFINS: TFrmChama_Tratamento_COFINS
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Consulta Tratamentos de COFINS'
  ClientHeight = 553
  ClientWidth = 942
  Color = clWindow
  ...
  object qrychama_tratamento: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TC.*, ITC.*,  RI1.Descricao, RI2.Descricao, RI3.Descricao' +
        ', RI4.Descricao, RI5.Descricao, RI6.Descricao from Tratamento_CO' +
        'FINS TC'
      
        'left join Itens_Tratamento_COFINS ITC on (TC.Codigo = ITC.Codigo' +
        ')'
      
        'inner join Regra_COFINS RI1 on (ITC.Entrada_Regra_EN = RI1.Codig' +
        'o)'
      
        'inner join Regra_COFINS RI2 on (ITC.Entrada_Regra_EPP = RI2.Codi' +
        'go)'
      
        'inner join Regra_COFINS RI3 on (ITC.Entrada_Regra_ME = RI3.Codig' +
        'o)'
      'inner join Regra_COFINS RI4 on (ITC.Saida_Regra_EN = RI4.Codigo)'
      
        'inner join Regra_COFINS RI5 on (ITC.Saida_Regra_EPP = RI5.Codigo' +
        ')'
      'inner join Regra_COFINS RI6 on (ITC.Saida_Regra_ME = RI6.Codigo)')
    Left = 464
    Top = 272
