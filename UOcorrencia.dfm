object FrmOcorrencia: TFrmOcorrencia
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object EdtTipo_Ocorrencia: TEdit
        Left = 60
        Top = 110
        Width = 213
        Height = 17
        ...
        ShowHint = False
        TabOrder = 6
        OnKeyPress = EdtTipo_OcorrenciaKeyPress
      end
      object EdtCodigo_Tipo_Ocorrencia: TEdit
        Left = 0
        Top = 110
        Width = 60
        Height = 17
        ...
        ShowHint = True
        TabOrder = 5
        OnDblClick = EdtCodigo_Tipo_OcorrenciaDblClick
        OnKeyDown = EdtCodigo_Tipo_OcorrenciaKeyDown
        OnKeyPress = EdtCodigo_Tipo_OcorrenciaKeyPress
      end
      ...
      object MEdtData_Ocorrencia: TMaskEdit
        Left = 133
        Top = 32
        Width = 79
        Height = 17
        ...
        TabOrder = 2
        Text = '  /  /    '
        OnEnter = MEdtData_OcorrenciaEnter
        OnExit = MEdtData_OcorrenciaExit
      end
