object FrmChama_Grupo_Produto_Tributacao: TFrmChama_Grupo_Produto_Tributacao
  Left = 0
  Top = 0
  ...
  object qrychama_grupo: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select GPT.*, TI.Descricao from Grupo_Produto_Tributacao GPT'
    ...
    object qrychama_grupoCodigo_Tratamento_ICMS: TIntegerField
      FieldName = 'Codigo_Tratamento_ICMS'
    end
