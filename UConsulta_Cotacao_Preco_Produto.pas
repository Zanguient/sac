...
uses UDM, UChama_Funcionario, URel_Consulta_Cotacao_Preco_Produto;
...
procedure TFrmConsulta_Cotacao_Preco_Produto.EdtCodigo_FuncionarioKeyDown(Sender: TObject;
