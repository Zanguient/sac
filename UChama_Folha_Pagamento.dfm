object FrmChama_Folha_Pagamento: TFrmChama_Folha_Pagamento
  ...
  object qrychama_folha: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select FP.*, Fun.Nome, Fun.Endereco, Fun.Numero, Fun.CPF,  Fun.T' +
        'elefone,'
      
        'Cid.Descricao as Cidade, Cid.UF, Em.Nome_Fantasia as Empresa fro' +
        'm Folha_Pagamento FP'
      
        'left join Funcionario Fun on (FP.Codigo_Funcionario = Fun.Codigo' +
        ')'
      'left join Empresa Em on (FP.Codigo_Empresa = Em.Codigo)'
      'left join Cidade Cid on (Fun.Codigo_Cidade = Cid.Codigo)')
    Left = 464
    Top = 272
    ...
    object qrychama_folhaCodigo_Empresa: TIntegerField
      FieldName = 'Codigo_Empresa'
    end
    ...
    object qrychama_folhaEmpresa: TStringField
      FieldName = 'Empresa'
      Size = 50
    end
    object qrychama_folhaEndereco: TStringField
      FieldName = 'Endereco'
      Size = 200
    end
    object qrychama_folhaNumero: TStringField
      FieldName = 'Numero'
      Size = 5
    end
    object qrychama_folhaCPF: TStringField
      FieldName = 'CPF'
    end
    object qrychama_folhaTelefone: TStringField
      FieldName = 'Telefone'
      Size = 13
    end
    object qrychama_folhaCidade: TStringField
      FieldName = 'Cidade'
      Size = 30
    end
    object qrychama_folhaUF: TStringField
      FieldName = 'UF'
      Size = 2
    end
  end
