object FrmRetorno_Cotacao: TFrmRetorno_Cotacao
  ...
  object ImgImagens_Comandos: TImageList
    ...
    Top = 8
    Bitmap = {
      494C010109000C006C0120002000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select Pro.Tipo, Pro.Codigo, Pro.Codigo_Venda, Pro.Descricao, UM' +
        '.Sigla from Produto Pro'
      
        'inner join Unidade_Medida UM on (Pro.Codigo_Unidade_Medida = UM.' +
        'Codigo)')
    Left = 384
    Top = 320
    object ADOQuery1Tipo: TIntegerField
      FieldName = 'Tipo'
    end
  ...
  object qryitens_retorno_cotacao: TADOQuery
    ...
    object qryitens_retorno_cotacaoCodigo_Venda: TStringField
      FieldKind = fkLookup
      FieldName = 'Codigo_Venda'
      LookupDataSet = ADOQuery1
      LookupKeyFields = 'Codigo'
      LookupResultField = 'Codigo_Venda'
