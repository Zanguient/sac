...
uses UDM, UDeclaracao, UGeral, UCompra;
...
begin
  try
    ...
    FrmCompra.EdtFornecedor.Text:= ADOQuery1Nome_Fantasia.AsString;
...
begin
  ...
  begin
    close;
    clear;
    add('select RC.N_Cotacao, RC.Codigo_Fornecedor, Forn.Nome_Fantasia from Retorno_Cotacao_Preco RC');
