unit URel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento;
...
type
  TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento: TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento;
...
procedure TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento.FormCreate(Sender: TObject);
var
  i: integer;
begin
...
procedure TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento.QRSubDetail1BeforePrint(
...
procedure TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TFrmRel_Impressao_DAV_OS_Meia_Pagina_Sem_Equipamento.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
  var
    i: integer;
    texto: string;
...
begin
  ...
  MMOObservacoes.Caption:= FrmPedido_Venda.MmoObservacao.Text;
end;
