object FrmConsulta_Retorno_Cotacao_Preco: TFrmConsulta_Retorno_Cotacao_Preco
  ...
  object RGConsulta_Por: TRadioGroup
    ...
    Items.Strings = (
      ...
      'Funcion'#225'rio'
      'Fornecedor'
      'Funcion'#225'rio / Data Cota'#231#227'o'
      'Funcion'#225'rio / Data Retorno'
  ...
  object qryconsulta_cotacao: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select RC.*, Forn.Nome_Fantasia, CP.Descricao as Cond_Pag, F.Nom' +
        'e from Retorno_Cotacao_Preco RC'
      
        'inner join Fornecedor Forn on (RC.Codigo_Fornecedor = Forn.Codig' +
        'o)'
      
        'inner join Condicao_Pagamento CP on (RC.Codigo_Condicao_Pagament' +
        'o = CP.Codigo)'
      'inner join Funcionario F on (RC.Codigo_Funcionario = F.Codigo)')
    Left = 478
    Top = 176
    object qryconsulta_cotacaoCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    ...
    object qryconsulta_cotacaoCodigo_Funcionario: TIntegerField
      FieldName = 'Codigo_Funcionario'
    end
    ...
    object qryconsulta_cotacaoNome_Fantasia: TStringField
      FieldName = 'Nome_Fantasia'
      Size = 50
    end
  ...
  object qryitens_cotacao: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select IRC.*, P.Codigo_Venda, P.Descricao, UM.Sigla from Itens_R' +
        'etorno_Cotacao_Preco IRC'
      'left join Produto P on (P.Codigo = IRC.Codigo_Produto)'
      
        'left join Unidade_Medida UM on (UM.Codigo = P.Codigo_Unidade_Med' +
        'ida)')
    Left = 491
    Top = 362
    ...
    object qryitens_cotacaoCodigo_Venda: TStringField
      FieldName = 'Codigo_Venda'
    end
