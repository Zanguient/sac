object FrmConsulta_Cotacao_Preco_Produto: TFrmConsulta_Cotacao_Preco_Produto
  ...
  object RGConsulta_Por: TRadioGroup
    ...
    Items.Strings = (
      ...
      'Funcion'#225'rio / Data Vencimento')
    TabOrder = 5
  end
  ...
  object qryconsulta_cotacao: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select CP.*, F.Nome from Cotacao_Preco_Produto CP'
      'inner join Funcionario F on (F.Codigo = CP.Codigo_Funcionario)')
    Left = 478
    Top = 176
  ...
  object qryitens_cotacao: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select IC.*, P.Codigo_Venda, P.Descricao, UM.Sigla from Itens_Co' +
        'tacao_Preco_Produto IC'
      'left join Produto P on (P.Codigo = IC.Codigo_Produto)'
