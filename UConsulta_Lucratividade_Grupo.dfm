object FrmConsulta_Lucratividade_Grupo: TFrmConsulta_Lucratividade_Grupo
  Left = 0
  Top = 0
  Anchors = [akLeft, akTop, akRight, akBottom]
  BorderStyle = bsSingle
  Caption = 'Consulta Lucratividade por Grupo de Produtos'
  ClientHeight = 536
  ClientWidth = 952
  Color = clWindow
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1Descricao_grupo: TcxGridDBColumn
        Caption = 'Grupo'
        DataBinding.FieldName = 'Descricao_grupo'
  ...
  object qryconsulta_lucro: TADOQuery
    ...
    Left = 437
    Top = 32
    object qryconsulta_lucroCodigo_Grupo: TIntegerField
      FieldName = 'Codigo_Grupo'
    end
    object qryconsulta_lucroDescricao_grupo: TStringField
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    Components = <
      ...
      item
        Component = cxGrid1DBTableView1Descricao_grupo
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
