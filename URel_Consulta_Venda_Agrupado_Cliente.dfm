object FrmRel_Consulta_Venda_Agrupado_Cliente: TFrmRel_Consulta_Venda_Agrupado_Cliente
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 533
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qrydados_agrupados_cliente.CodCliente'
      FooterBand = QRBand1
      Master = QuickRep1
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        Expression = 
          'SUM(qrydados_agrupados_cliente.Qtde * qrydados_agrupados_cliente' +
          '.Valor_Unitario)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
  ...
  object qrydados_agrupados_cliente: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'where Ped.Data_Venda between '#39'01/06/2014'#39' and '#39'31/12/2014'#39
      'order by C.Nome_Nome_Fantasia, IP.Descricao')
    Left = 467
    Top = 10
