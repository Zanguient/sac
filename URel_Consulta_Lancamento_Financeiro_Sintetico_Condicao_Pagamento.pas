unit URel_Consulta_Lancamento_Financeiro_Sintetico_Condicao_Pagamento;
...
type
  TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao: TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao;
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.ADOQuery1Data_PagamentoGetText(
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.FormCreate(Sender: TObject);
begin
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.Atualiza_Query;
begin
  with ADOQuery1 do
    begin
      close;
      ...
      sql.add('PL.Codigo_Forma_Pagamento_Parcela, CP.Descricao as Cond_Pag');
      ...
      begin
        ...
        begin
          sql.add('where LF.Codigo_Empresa = :Empresa and LF.Data_Lancamento between :DI and :DF and LF.Tipo = :Tipo_Lan and PL.Status = :Status and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
        ...
        begin
          sql.add('where LF.Codigo_Empresa = :Empresa and PL.Status = :Status and PL.Data_Vencimento between :DI and :DF and LF.Tipo = :Tipo_Lan and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
          Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
          Parameters.ParamByName('DI').Value:= StrToDateTime(FrmConsulta_Lancamentos_Financeiros.MEdtData_Inicial.Text);
          Parameters.ParamByName('DF').Value:= StrToDateTime(FrmConsulta_Lancamentos_Financeiros.MEdtData_Final.Text);
      ...
      begin
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and PL.N_Documento = :Documento and LF.Tipo = :Tipo_Lan and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
      ...
      begin
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and LF.Codigo_Cli_For = :Codigo and LF.Tipo = :Tipo_Lan and LF.Data_Lancamento between :DI and :DF and PL.Status = :Status and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and PL.Status = :Status and LF.Codigo_Cli_For = :Codigo and LF.Tipo = :Tipo_Lan and PL.Data_Vencimento between :DI and :DF and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
            Parameters.ParamByName('Codigo').Value:= FrmConsulta_Lancamentos_Financeiros.EdtCodigo_Cli_For.Text;
      ...
      begin
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and LF.Codigo_Plano = :Codigo and LF.Tipo = :Tipo_Lan and LF.Data_Lancamento between :DI and :DF  and PL.Status = :Status and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
            Parameters.ParamByName('Codigo').Value:= FrmConsulta_Lancamentos_Financeiros.EdtCodigo_Cli_For.Text;
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and PL.Status = :Status and LF.Codigo_Plano = :Codigo and LF.Tipo = :Tipo_Lan and PL.Data_Vencimento between :DI and :DF and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
            Parameters.ParamByName('Codigo').Value:= FrmConsulta_Lancamentos_Financeiros.EdtCodigo_Cli_For.Text;
      ...
      begin
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and LF.Codigo_Departamento = :Codigo and LF.Tipo = :Tipo_Lan and LF.Data_Lancamento between :DI and :DF  and PL.Status = :Status and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
            Parameters.ParamByName('Codigo').Value:= FrmConsulta_Lancamentos_Financeiros.EdtCodigo_Cli_For.Text;
          ...
          begin
            sql.add('where LF.Codigo_Empresa = :Empresa and PL.Status = :Status and LF.Codigo_Departamento = :Codigo and LF.Tipo = :Tipo_Lan and PL.Data_Vencimento between :DI and :DF and (LF.Conta_Fixa = :Conta1 or LF.Conta_Fixa = :Conta2) order by CP.Descricao');
            Parameters.ParamByName('Empresa').value:= Codigo_Empresa;
            Parameters.ParamByName('Codigo').Value:= FrmConsulta_Lancamentos_Financeiros.EdtCodigo_Cli_For.Text;
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.QRDBText1Print(
  sender: TObject; var Value: string);
begin
  {ADOQuery2.Close;
  ADOQuery2.Parameters.ParamByName('Codigo').Value:= StrToInt(Value);//FrmConsulta_Lancamentos_Financeiros.qryconsulta_lancamento_sinteticoCodigo.AsInteger;
  ADOQuery2.Open;}
  Atualiza_Query2(Value);
end;

procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.Atualiza_Query2(N_Documento: AnsiString);
begin
  with ADOQuery2, sql do
  begin
    close;
    clear;
    add('select PLH.*, CP.Descricao as Cond_Pag from Parcelas_Lancamentos_Historico PLH');
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Condicao.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
