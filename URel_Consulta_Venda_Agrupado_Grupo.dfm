object FrmRel_Consulta_Venda_Agrupado_Grupo: TFrmRel_Consulta_Venda_Agrupado_Grupo
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 533
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        Expression = 
          'SUM(qrydados_agrupados_grupo.Qtde * qrydados_agrupados_grupo.Val' +
          'or_Unitario)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
  ...
  object qrydados_agrupados_grupo: TADOQuery
    ...
    SQL.Strings = (
      ...
      'order by GP.Descricao, IP.Descricao')
    Left = 467
    Top = 10
