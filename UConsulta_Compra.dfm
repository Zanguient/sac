object FrmConsulta_Compra: TFrmConsulta_Compra
  ...
  object qryconsulta_compra: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select C.*, Forn.Nome_Fantasia, Fun.Nome, CP.Descricao from Comp' +
        'ra C'
      
        'inner join Fornecedor Forn on (C.Codigo_Fornecedor = Forn.Codigo' +
        ')'
      
        'inner join Funcionario Fun on (C.Codigo_Funcionario = Fun.Codigo' +
        ')'
    ...
    object qryconsulta_compraCodigo_Funcionario: TIntegerField
      FieldName = 'Codigo_Funcionario'
    end
    ...
    object qryconsulta_compraNome_Fantasia: TStringField
      FieldName = 'Nome_Fantasia'
      Size = 50
    end
  ...
  object qryitens_compra: TADOQuery
    ...
    SQL.Strings = (
        ...
        'mpra IC'
      'inner join Produto P on (IC.Codigo_Produto = P.Codigo)'
    ...
    object qryitens_compraCodigo_Venda: TStringField
      FieldName = 'Codigo_Venda'
    end
