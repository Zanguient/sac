object FrmRel_Consulta_Entrada_Sintetico1: TFrmRel_Consulta_Entrada_Sintetico1
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'IE.Total_Produtos, IE.Total_Nota, IE.Custo_Total, IEnt.N_Item, I' +
        'Ent.Unidade, IEnt.Valor_Unitario, IEnt.Quantidade, IEnt.Valor_To' +
        'tal,'
      'P.Codigo_Venda, P.Descricao  from Entrada_Produtos EP'
        ...
        'left join Itens_Entrada IEnt on (EP.N_Nota_Fiscal = IEnt.N_Nota_' +
        'Fiscal)'
      'left join Produto P on(IEnt.Codigo_Produto = P.Codigo)'
      '')
    Left = 400
    Top = 8
