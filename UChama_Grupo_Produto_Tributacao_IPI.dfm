object FrmChama_Grupo_Produto_Tributacao_IPI: TFrmChama_Grupo_Produto_Tributacao_IPI
  Left = 0
  Top = 0
  ...
  object qrychama_grupo: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select GPTIPI.*, TIPI.Descricao from Grupo_Produto_Tributacao_IP' +
        'I GPTIPI'
      
        'inner join Tratamento_IPI TIPI on (GPTIPI.Codigo_Tratamento_IPI ' +
        '= TIPI.Codigo)')
    Left = 464
    Top = 272
    ...
    object qrychama_grupoCodigo_Tratamento_IPI: TIntegerField
      FieldName = 'Codigo_Tratamento_IPI'
    end
