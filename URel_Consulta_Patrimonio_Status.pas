unit URel_Consulta_Patrimonio_Status;
...
type
  TFrmRel_Consulta_Patrimonio_Status = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Patrimonio_Status: TFrmRel_Consulta_Patrimonio_Status;
...
procedure TFrmRel_Consulta_Patrimonio_Status.FormCreate(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Patrimonio_Status.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
