object FrmRel_Consulta_Comissao_Lucratividade: TFrmRel_Consulta_Comissao_Lucratividade
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand2: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryconsulta.Valor_Compra)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryconsulta.Valor_Venda)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object qryconsulta: TADOQuery
    ...
    SQL.Strings = (
        ...
        'um(P.Total_Pedido) as Valor_Venda,'
      
        '( (sum(P.Total_Pedido) - sum(IP.Valor_Compra * IP.Qtde)) / sum(P' +
        '.Total_Pedido) *100 ) as Total from Itens_Pedido IP'
    ...
    object qryconsultaValor_Venda: TFloatField
