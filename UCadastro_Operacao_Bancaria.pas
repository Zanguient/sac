...
uses UDM, UChama_Operacao_Bancaria, UDeclaracao;
...
begin
  ...
  BEGIN
    ...
    UDeclaracao.Insere_Historico(usuario, 'EXCLUIU OPERAÇÃO BANCÁRIA ' + EdtOperacao.Text + '.', TimeToStr(time), exclusao, date);
    BBtnSalvar.Enabled:= false;
    BBtnExcluir.Enabled:= false;
    BBtnPesquisar.Enabled:= true;
    BBtnCancelar.Enabled:= false;
  ...
  if (achei = false) then
    begin
      ...
      BEGIN
        ...
        UDeclaracao.Insere_Historico(usuario, 'CADASTROU OPERAÇÃO BANCÁRIA ' + EdtOperacao.Text + '.', TimeToStr(time), insercao, date);
      END
      else
        exit;
    end
    ...
    begin
      ...
      BEGIN
        ...
        UDeclaracao.Insere_Historico(usuario, 'ALTEROU OPERAÇÃO BANCÁRIA ' + EdtOperacao.Text + '.', TimeToStr(time), alteracao, date);
      END
      else
        exit;
    end;
