unit URel_Consulta_Venda_Sintetico2;
...
type
  TFrmRel_Consulta_Venda_Sintetico2 = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Venda_Sintetico2: TFrmRel_Consulta_Venda_Sintetico2;
...
procedure TFrmRel_Consulta_Venda_Sintetico2.FormCreate(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Venda_Sintetico2.QRBand3BeforePrint(Sender: TQRCustomBand;
...
procedure TFrmRel_Consulta_Venda_Sintetico2.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
    ...
    begin
      with ADOQuery1, sql do
        begin
          close;
          sql.clear;
          add('select Ped.*, li.Nome_Nome_Fantasia from Pedido Ped');
          add('left join Cliente Cli on (Ped.Codigo_Cliente = Cli.Codigo)');
