unit URel_Consulta_Produto_Cadastrado;
...
type
  TFrmRel_Consulta_Produto_Cadastrado = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Produto_Cadastrado: TFrmRel_Consulta_Produto_Cadastrado;
...
procedure TFrmRel_Consulta_Produto_Cadastrado.FormCreate(Sender: TObject);
begin
//  if (FrmEscolha_Impressao.preview = true) then
    QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Produto_Cadastrado.qryconsultaData_FabricacaoGetText(
...
procedure TFrmRel_Consulta_Produto_Cadastrado.qryconsultaData_ValidadeGetText(
  Sender: TField; var Text: string; DisplayText: Boolean);
begin
  if (Sender.AsString = '30/12/1899') then
    Text:= ''
...
procedure TFrmRel_Consulta_Produto_Cadastrado.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  ...
  case FrmConsulta_Produto_Cadastrado.RGStatus.ItemIndex of
    0: LblStatus.Caption:= 'Ativo';
    1: LblStatus.Caption:= 'Inativo';
  end;
  ...
  begin
    ...
    LblPeriodo.Caption:= FrmConsulta_Produto_Cadastrado.MEdtData_Inicial.Text + ' a ' + FrmConsulta_Produto_Cadastrado.MEdtData_Final.Text;
  end;
