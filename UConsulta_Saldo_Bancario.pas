...
type
  TFrmConsulta_Saldo_Bancario = class(TForm)
    ...
    qryconsulta_saldoData_Abertura: TDateTimeField;
    qryconsulta_saldoData_Cadastro: TDateTimeField;
    qryconsulta_saldoConta: TStringField;
    qryconsulta_saldoAgencia: TStringField;
    qryconsulta_saldoCodigo_Banco: TIntegerField;
    qryconsulta_saldoNome_Agencia: TStringField;
...
uses UDM, UEscolha_Impressao,  UChama_Conta_Corrente,
  URel_Consulta_Saldo_Bancario;
...
begin
  Consulta.Consulta_Saldo(EdtConsulta.Text);
