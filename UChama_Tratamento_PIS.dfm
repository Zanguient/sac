object FrmChama_Tratamento_PIS: TFrmChama_Tratamento_PIS
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Consulta Tratamentos de PIS'
  ClientHeight = 553
  ClientWidth = 942
  Color = clWindow
  ...
  object qrychama_tratamento: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TPIS.*, ITPIS.*, RI1.Descricao, RI2.Descricao, RI3.Descri' +
        'cao, RI4.Descricao, RI5.Descricao, RI6.Descricao from Tratamento' +
        '_PIS TPIS'
      
        'left join Itens_Tratamento_PIS ITPIS on (TPIS.Codigo = ITPIS.Cod' +
        'igo)'
      
        'inner join Regra_PIS RI1 on (ITPIS.Entrada_Regra_EN = RI1.Codigo' +
        ')'
      
        'inner join Regra_PIS RI2 on (ITPIS.Entrada_Regra_EPP = RI2.Codig' +
        'o)'
      
        'inner join Regra_PIS RI3 on (ITPIS.Entrada_Regra_ME = RI3.Codigo' +
        ')'
      'inner join Regra_PIS RI4 on (ITPIS.Saida_Regra_EN = RI4.Codigo)'
      'inner join Regra_PIS RI5 on (ITPIS.Saida_Regra_EPP = RI5.Codigo)'
      'inner join Regra_PIS RI6 on (ITPIS.Saida_Regra_ME = RI6.Codigo)')
    Left = 464
    Top = 272
