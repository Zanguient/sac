object FrmChama_Regra_ISSQN: TFrmChama_Regra_ISSQN
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Consulta Regras de ISSQN'
  ClientHeight = 553
  ClientWidth = 942
  Color = clWindow
  ...
  object qrychama_regra: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select RISS.* from Regra_ISSQN RISS')
    Left = 464
    Top = 272
    ...
    object qrychama_regraTributacao: TStringField
