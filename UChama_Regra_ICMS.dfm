object FrmChama_Regra_ICMS: TFrmChama_Regra_ICMS
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Consulta Regras de ICMS'
  ClientHeight = 553
  ClientWidth = 942
  Color = clWindow
  ...
  object qrychama_regra: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select RI.*, CST.Codigo_Situacao, CST.Descricao as Situacao from' +
        ' Regra_ICMS RI'
    ...
    object qrychama_regraTipo_Calculo_BC_ICMS: TStringField
      FieldName = 'Tipo_Calculo_BC_ICMS'
      Size = 50
    end
    object qrychama_regraTipo_Calculo_BC_ICMS_ST: TStringField
    ...
    object qrychama_regraCFOP_D: TStringField
      FieldName = 'CFOP_D'
      Size = 10
    end
    object qrychama_regraCFOP_F: TStringField
      FieldName = 'CFOP_F'
      Size = 10
    end
  end
