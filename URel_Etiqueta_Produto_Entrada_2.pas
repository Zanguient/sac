unit URel_Etiqueta_Produto_Entrada_2;
  ...
  while not FrmEntrada_Produtos.qryitens_entrada.Eof do
    begin
      for x := 1 to FrmEntrada_Produtos.qryitens_entradaQuantidade.AsInteger do
        begin
          Text:= '';
          texto:= 'CÓDIGO....: '+ FrmEntrada_Produtos.qryitens_entrada.FieldByName('Codigo_Produto').AsString + #13;
          texto:= texto +
                  'DESCRIÇÃO.: ' + FrmEntrada_Produtos.qryitens_entrada.FieldByName('Descricao_Produto').AsString;
          //texto:= texto + 'MARCA.....: '+ FrmEntrada_Produtos.qryitens_entrada.FieldByName('Marca').AsString;
