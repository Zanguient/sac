...
uses UDM, UGera_Etiqueta_Produto;
  ...
  while not FrmGera_Etiqueta_Produto.ClientDataSet1.Eof do
    begin
      for x := 1 to FrmGera_Etiqueta_Produto.ClientDataSet1.FieldByName('Quantidade').AsInteger do
        begin
          Text:= '';
          texto:= FrmGera_Etiqueta_Produto.ClientDataSet1.FieldByName('Codigo_Produto').AsString + #13;
          texto:= texto +
                  FrmGera_Etiqueta_Produto.ClientDataSet1.FieldByName('Descricao').AsString + #13;
          texto:= texto +
                  FrmGera_Etiqueta_Produto.ClientDataSet1.FieldByName('Codigo_Ficticio').AsString + #13;
          texto:= texto +
                  FormatFloat('#0.0,0',FrmGera_Etiqueta_Produto.ClientDataSet1.FieldByName('Valor').AsFloat);
