...
begin
  ...
  CBModalidade_BC_ICMS.Items.Add('Preço Tabelado Máx. (valor)');
  CBModalidade_BC_ICMS.Items.Add('Valor da Operação');
...
begin
  ...
  begin
    CBModalidade_BC_ICMS.Clear;
    CBModalidade_BC_ICMS.Items.Add('Preço Tabelado ou Máximo Sugerido');
