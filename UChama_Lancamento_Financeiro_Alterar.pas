...
procedure TFrmChama_Lancamento_Financeiro_Alterar.DBGrid1TitleClick(
  Column: TColumn);
begin
...
procedure TFrmChama_Lancamento_Financeiro_Alterar.EdtConsultaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key = vk_return) then
  begin
...
procedure TFrmChama_Lancamento_Financeiro_Alterar.RGTipoClick(Sender: TObject);
begin
  Consulta.Chama_Lancamento_Financeiro_Alterar;
end;
