object FrmConciliacao_Compra: TFrmConciliacao_Compra
  ...
  object ImgImagens_Comandos: TImageList
    ...
    Top = 8
    Bitmap = {
      494C010109000C00380120002000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object qryitens_compra: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select CC.*, P.Codigo_Venda, P.Descricao, UM.Sigla from Concilia' +
        'cao_Compra CC'
      'inner join Produto P on (CC.Codigo_Produto = P.Codigo)'
