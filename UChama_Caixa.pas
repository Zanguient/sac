...
uses UDM, UCadastro_Caixa, UBaixar_Titulo, UAbertura_Caixa, UAltera_Caixa,
...
procedure TFrmChama_Caixa.BBtnFiltrarClick(Sender: TObject);
begin
  Consulta.Chama_Caixa(EdtConsulta.Text);
end;
...
begin
    ...
    begin
      ...
      FrmCadastro_Caixa.BBtnNovo.Enabled:= False;
    ...
    begin
      FrmAltera_Caixa.EdtCodigo_Caixa.Text:= qrychama_caixaCodigo.AsString;
      FrmAltera_Caixa.EdtCaixa.Text:= qrychama_caixaCaixa.AsString;
      FrmChama_Caixa.Close;
    end
...
procedure TFrmChama_Caixa.EdtConsultaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key = vk_return) then
  begin
