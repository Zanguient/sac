object FrmCadastro_Observacao_Fiscal: TFrmCadastro_Observacao_Fiscal
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Observa'#231#227'o Fiscal'
  ClientHeight = 232
  ClientWidth = 534
  Color = clWindow
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object EdtDescricao: TEdit
        ...
        Height = 17
        Hint = 
          'Se a mensagem sugere o aproveitamento de cr'#233'dito, substitua o va' +
          'lor do imposto por * (asterisco) e o valor da al'#237'quota por ** (d' +
          'ois asteriscos).'
        BevelInner = bvNone
        BevelKind = bkFlat
        BevelOuter = bvRaised
