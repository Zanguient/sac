unit URel_Consulta_Reposicao_Estoque_Produto;
...
uses
  ...
  QRPDFFilt, QRExport, qrpctrls;

type
  TFrmRel_Consulta_Reposicao_Estoque_Produto = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Reposicao_Estoque_Produto: TFrmRel_Consulta_Reposicao_Estoque_Produto;
...
procedure TFrmRel_Consulta_Reposicao_Estoque_Produto.FormCreate(Sender: TObject);
begin
  // if (FrmEscolha_Impressao.preview = true) then
  QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Reposicao_Estoque_Produto.
...
procedure TFrmRel_Consulta_Reposicao_Estoque_Produto.QuickRep1BeforePrint
