unit URel_Consulta_Reposicao_Estoque_Marca;
...
type
  TFrmRel_Consulta_Reposicao_Estoque_Marca = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Reposicao_Estoque_Marca: TFrmRel_Consulta_Reposicao_Estoque_Marca;
...
procedure TFrmRel_Consulta_Reposicao_Estoque_Marca.FormCreate(Sender: TObject);
begin
  // if (FrmEscolha_Impressao.preview = true) then
  QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Reposicao_Estoque_Marca.
...
procedure TFrmRel_Consulta_Reposicao_Estoque_Marca.QuickRep1BeforePrint
