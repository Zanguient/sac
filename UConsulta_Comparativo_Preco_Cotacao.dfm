object FrmConsulta_Comparativo_Preco_Cotacao: TFrmConsulta_Comparativo_Preco_Cotacao
  ...
  object qryconsulta_cotacao: TADOQuery
    ...
    SQL.Strings = (
        ...
        ', RC.Prazo_Entrega, CP.Descricao as Cond_Pag, Forn.Nome_Fantasia' +
        ', P.Codigo_Venda, P.Descricao, UM.Sigla from Itens_Retorno_Cotac' +
        'ao_Preco IRC'
      'inner join Retorno_Cotacao_Preco RC on (IRC.Codigo = RC.Codigo )'
      ...
      'left join Produto P on (P.Codigo = IRC.Codigo_Produto)'
        ...
        'ida)'
      'where RC.N_Cotacao = 1 order by P.Descricao, IRC.Valor_Unitario')
    Left = 711
    Top = 71
    ...
    object qryconsulta_cotacaoCodigo_Venda: TStringField
      FieldName = 'Codigo_Venda'
    end
