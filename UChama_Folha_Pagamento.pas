...
type
  TFrmChama_Folha_Pagamento = class(TForm)
    ...
    qrychama_folhaCodigo_Empresa: TIntegerField;
    ...
    qrychama_folhaEmpresa: TStringField;
    qrychama_folhaEndereco: TStringField;
    qrychama_folhaNumero: TStringField;
    qrychama_folhaCPF: TStringField;
    qrychama_folhaTelefone: TStringField;
    qrychama_folhaCidade: TStringField;
    qrychama_folhaUF: TStringField;
...
begin
  if (FrmFolha_Pagamento <> NIL) and (FrmFolha_Pagamento.ativo = true) then
    begin
      ...
      FrmFolha_Pagamento.EdtEmpresa.Text:= qrychama_folhaEmpresa.AsString;
      FrmFolha_Pagamento.EdtCodigo_Empresa.Text:= qrychama_folhaCodigo_Empresa.AsString;
      ...
      FrmFolha_Pagamento.LblCPF.Caption:= qrychama_folhaCPF.AsString;
      FrmFolha_Pagamento.LblCidade.Caption:= qrychama_folhaCidade.AsString;
      //FrmFolha_Pagamento.LblSetor.Caption:= qrychama_funcionarioSetor.AsString;
      FrmFolha_Pagamento.LblEndereco.Caption:= qrychama_folhaEndereco.AsString;
      FrmFolha_Pagamento.LblUF.Caption:= qrychama_folhaUF.AsString;
      FrmFolha_Pagamento.LblNumero.Caption:= qrychama_folhaNumero.AsString;
      FrmFolha_Pagamento.LblTelefone.Caption:= qrychama_folhaTelefone.AsString;

      if (FrmFolha_Pagamento.Conexao = nil) then
      begin
        FrmFolha_Pagamento.Conexao:= TADOConnection.Create(self);
      end;

      if (FrmFolha_Pagamento.Conexao.InTransaction = false) then
      begin
        FrmFolha_Pagamento.Cria_Conexao;
      end;
      ...
      FrmFolha_Pagamento.BBtnNovo.Enabled:= false;
