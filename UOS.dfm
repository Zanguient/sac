object FrmOS: TFrmOS
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object LblCodigo_Anterior: TLabel
        Left = 191
        Top = 34
        Width = 88
        Height = 13
      ...
      object PageControl2: TPageControl
        ...
        object TabSheet4: TTabSheet
          ...
          object EdtValor_Total_Servico: TEdit
            Left = 602
            Top = 16
            Width = 83
            Height = 17
            ...
            TabOrder = 4
            Text = '0,00'
            OnEnter = EdtValor_Total_ServicoEnter
            OnKeyDown = EdtValor_Total_ServicoKeyDown
            OnKeyPress = EdtValor_Total_ServicoKeyPress
          end
          object EdtDesconto_Servico: TEdit
            Left = 542
            Top = 16
            Width = 61
            Height = 17
            ...
            TabOrder = 3
            Text = '0,00'
            OnExit = EdtDesconto_ServicoExit
            OnKeyPress = EdtDesconto_ServicoKeyPress
          end
          object EdtUnidade_Servico: TEdit
            Left = 388
            Top = 16
            Width = 42
            Height = 17
        ...
        object TabSheet3: TTabSheet
          Caption = 'Problema(s)/Solu'#231#227'o('#245'es)'
          ImageIndex = 2
          ExplicitLeft = 0
          ExplicitTop = 0
          ExplicitWidth = 0
          ...
          object MMOProblema_Reclamado: TMemo
            Left = 2
            Top = 21
            Width = 751
            Height = 56
          ...
          object MMOProblema_Constatado: TMemo
            Left = 2
            Top = 102
            Width = 751
            Height = 55
      ...
      object EdtN_Pedido: TEdit
        ...
        Width = 85
        Height = 17
        Hint = 'Digite o n'#250'mero do DAV-OS e pressione Enter'
        BevelInner = bvNone
        BevelKind = bkFlat
        BevelOuter = bvRaised
        BorderStyle = bsNone
      ...
      object EdtDAV_Anterior: TEdit
        ...
        ShowHint = True
        TabOrder = 2
        OnKeyDown = EdtDAV_AnteriorKeyDown
      end
      object CBFechar: TCheckBox
        Left = 187
        Top = 110
        Width = 97
        Height = 17
  ...
  object TlbFerramentas: TToolBar
    ...
    ShowHint = False
    TabOrder = 1
    object BBtnSalvar_OS: TToolButton
      Left = 0
      Top = 0
      Cursor = crHandPoint
      Caption = '&Salvar O.S'
  ...
  object Panel1: TPanel
    ...
    Height = 22
    BorderStyle = bsSingle
    Caption = 'DAV-OS'#39's Anteriores'
    Color = clMenu
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object qryitens_venda: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select IP.*, P.Codigo_Venda, P.Descricao, P.Tipo from Itens_Pedi' +
        'do IP'
    ...
    object qryitens_vendaValor_ICMS: TFloatField
    ...
    object qryitens_vendaTipo: TIntegerField
      FieldName = 'Tipo'
    end
  end
  ...
  object qryitens_os: TADOQuery
    ...
    object qryitens_osN_Item: TStringField
      FieldName = 'N_Item'
      Size = 10
    end
    object qryitens_osCodigo_Produto: TIntegerField
      FieldName = 'Codigo_Produto'
    end
    object qryitens_osUN: TStringField
      FieldName = 'UN'
      Size = 10
    end
    object qryitens_osICMS: TStringField
      FieldName = 'ICMS'
      Size = 10
    end
    object qryitens_osCST: TStringField
      FieldName = 'CST'
      Size = 10
    end
    object qryitens_osBase_Reduzida: TStringField
      FieldName = 'Base_Reduzida'
      Size = 5
    end
    object qryitens_osBase_Acrescida: TStringField
      FieldName = 'Base_Acrescida'
      Size = 5
    end
    object qryitens_osBC: TStringField
      FieldName = 'BC'
      Size = 10
    end
    object qryitens_osValor_ICMS: TFloatField
      FieldName = 'Valor_ICMS'
    end
    object qryitens_osIPI: TStringField
      FieldName = 'IPI'
      Size = 10
    end
    object qryitens_osCST_IPI: TStringField
      FieldName = 'CST_IPI'
      Size = 10
    end
    object qryitens_osBase_Reduzida_IPI: TStringField
      FieldName = 'Base_Reduzida_IPI'
      Size = 10
    end
    object qryitens_osBase_Acrescida_IPI: TStringField
      FieldName = 'Base_Acrescida_IPI'
      Size = 10
    end
    object qryitens_osBC_IPI: TStringField
      FieldName = 'BC_IPI'
      Size = 10
    end
    object qryitens_osValor_IPI: TFloatField
      FieldName = 'Valor_IPI'
    end
    object qryitens_osPIS: TStringField
      FieldName = 'PIS'
      Size = 10
    end
    object qryitens_osCST_PIS: TStringField
      FieldName = 'CST_PIS'
      Size = 10
    end
    object qryitens_osBase_Reduzida_PIS: TStringField
      FieldName = 'Base_Reduzida_PIS'
      Size = 10
    end
    object qryitens_osBase_Acrescida_PIS: TStringField
      FieldName = 'Base_Acrescida_PIS'
      Size = 10
    end
    object qryitens_osBC_PIS: TStringField
      FieldName = 'BC_PIS'
      Size = 10
    end
    object qryitens_osValor_PIS: TFloatField
      FieldName = 'Valor_PIS'
    end
    object qryitens_osCOFINS: TStringField
      FieldName = 'COFINS'
      Size = 10
    end
    object qryitens_osCST_COFINS: TStringField
      FieldName = 'CST_COFINS'
      Size = 10
    end
    object qryitens_osBase_Reduzida_COFINS: TStringField
      FieldName = 'Base_Reduzida_COFINS'
      Size = 10
    end
    object qryitens_osBase_Acrescida_COFINS: TStringField
      FieldName = 'Base_Acrescida_COFINS'
      Size = 10
    end
    object qryitens_osBC_COFINS: TStringField
      FieldName = 'BC_COFINS'
      Size = 10
    end
    object qryitens_osValor_COFINS: TFloatField
      FieldName = 'Valor_COFINS'
    end
    object qryitens_osQtde: TFloatField
      FieldName = 'Qtde'
    end
    object qryitens_osQtde_Entregue: TFloatField
      FieldName = 'Qtde_Entregue'
    end
    object qryitens_osQtde_Restante: TFloatField
      FieldName = 'Qtde_Restante'
    end
    ...
    object qryitens_osAcrecimo: TFloatField
      FieldName = 'Acrecimo'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_osTipo_Acrecimo: TStringField
      FieldName = 'Tipo_Acrecimo'
      Size = 1
    end
    ...
    object qryitens_osSub_Total_Liquido: TFloatField
      FieldName = 'Sub_Total_Liquido'
    end
    object qryitens_osCancelado: TStringField
      FieldName = 'Cancelado'
      Size = 1
    end
    ...
    object qryitens_osTipo: TIntegerField
      FieldName = 'Tipo'
    end
  end
