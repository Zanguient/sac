unit URel_Etiqueta_Produto_Entrada;
...
type
  TFrmRel_Etiqueta_Produto_Entrada = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Etiqueta_Produto_Entrada: TFrmRel_Etiqueta_Produto_Entrada;
...
procedure TFrmRel_Etiqueta_Produto_Entrada.FormCreate(Sender: TObject);
begin
  Monta_Relatorio;
end;

procedure TFrmRel_Etiqueta_Produto_Entrada.Monta_Relatorio;
begin
  //qtde colunas
...
procedure TFrmRel_Etiqueta_Produto_Entrada.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
  var
    x: integer;
    texto: string;
  ...
  while not FrmEntrada_Produtos.qryitens_entrada.Eof do
    begin
      for x := 1 to FrmEntrada_Produtos.qryitens_entradaQuantidade.AsInteger do
        begin
          Text:= '';
          texto:= 'Codigo Venda.....: ' + FrmEntrada_Produtos.qryitens_entradaCodigo_Produto.AsString + #13;
          texto:= texto +
                  'Descrição........: ' + FrmEntrada_Produtos.qryitens_entradaDescricao_Produto.AsString + #13;
          texto:= texto +
                  'Codigo Fictício..: ' + FrmEntrada_Produtos.qryitens_entradaCodigo_Produto.AsString + #13;
          texto:= texto +
                  'Valor Venda......: ' + FrmEntrada_Produtos.qryitens_entradaValor_Vista.AsString;
