unit URel_Consulta_Lancamento_Financeiro_Sintetico_Teste;
...
type
  TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste: TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste;
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.ADOQuery1Data_PagamentoGetText(
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.Atualiza_Query;
begin
  with ADOQuery1 do
    begin
      close;
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.FormCreate(Sender: TObject);
begin
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.QRDBText4Print(
  sender: TObject; var Value: string);
begin
  //valor:= valor + StrToFloat(Value);
end;

procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.QRDBText5Print(
  sender: TObject; var Value: string);
begin
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.Atualiza_Query2(N_Documento: AnsiString);
begin
...
procedure TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  ...
  //LblValor.Caption:= FloatToStr(valor);
