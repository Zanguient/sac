object FrmMovimentacao_Manual: TFrmMovimentacao_Manual
  Left = 225
  Top = 20
      ...
      object PageControl2: TPageControl
        ...
        object TabSheet2: TTabSheet
          ...
          object EdtDesconto_Item: TEdit
            ...
            TabOrder = 6
            Text = '0,00'
            OnKeyDown = EdtDesconto_ItemKeyDown
          end
          object EdtST: TEdit
            Left = 410
            Top = 16
  ...
  object qryitens_movimentacao: TADOQuery
    Connection = DM.ADOConnection1
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'select IMM.*, UM.Sigla as Unidade, P.Codigo_Venda, P.Descricao, ' +
        'P.Estoque, P.Valor_Medio from Itens_Movimentacao_Manual IMM'
      'inner join Produto P on (IMM.Codigo_Produto = P.Codigo)'
      
        'inner join Unidade_Medida UM on (P.Codigo_Unidade_Medida = UM.Co' +
        'digo)')
    Left = 328
    Top = 280
    object qryitens_movimentacaoCodigo: TIntegerField
      FieldName = 'Codigo'
    end
    object qryitens_movimentacaoSequencia: TStringField
      FieldName = 'Sequencia'
      Size = 3
    end
    object qryitens_movimentacaoCodigo_Produto: TIntegerField
      FieldName = 'Codigo_Produto'
    end
    object qryitens_movimentacaoUN: TStringField
      FieldName = 'UN'
      Size = 10
    end
    object qryitens_movimentacaoICMS: TStringField
      FieldName = 'ICMS'
      Size = 10
    end
    object qryitens_movimentacaoCST: TStringField
      FieldName = 'CST'
      Size = 10
    end
    object qryitens_movimentacaoBase_Reduzida: TStringField
      FieldName = 'Base_Reduzida'
      Size = 5
    end
    object qryitens_movimentacaoBase_Acrescida: TStringField
      FieldName = 'Base_Acrescida'
      Size = 5
    end
    object qryitens_movimentacaoBC: TStringField
      FieldName = 'BC'
      Size = 10
    end
    object qryitens_movimentacaoValor_ICMS: TFloatField
      FieldName = 'Valor_ICMS'
    end
    object qryitens_movimentacaoIPI: TStringField
      FieldName = 'IPI'
      Size = 10
    end
    object qryitens_movimentacaoCST_IPI: TStringField
      FieldName = 'CST_IPI'
      Size = 10
    end
    object qryitens_movimentacaoBase_Reduzida_IPI: TStringField
      FieldName = 'Base_Reduzida_IPI'
      Size = 10
    end
    object qryitens_movimentacaoBase_Acrescida_IPI: TStringField
      FieldName = 'Base_Acrescida_IPI'
      Size = 10
    end
    object qryitens_movimentacaoBC_IPI: TStringField
      FieldName = 'BC_IPI'
      Size = 10
    end
    object qryitens_movimentacaoValor_IPI: TFloatField
      FieldName = 'Valor_IPI'
    end
    object qryitens_movimentacaoPIS: TStringField
      FieldName = 'PIS'
      Size = 10
    end
    object qryitens_movimentacaoCST_PIS: TStringField
      FieldName = 'CST_PIS'
      Size = 10
    end
    object qryitens_movimentacaoBase_Reduzida_PIS: TStringField
      FieldName = 'Base_Reduzida_PIS'
      Size = 10
    end
    object qryitens_movimentacaoBase_Acrescida_PIS: TStringField
      FieldName = 'Base_Acrescida_PIS'
      Size = 10
    end
    object qryitens_movimentacaoBC_PIS: TStringField
      FieldName = 'BC_PIS'
      Size = 10
    end
    object qryitens_movimentacaoValor_PIS: TFloatField
      FieldName = 'Valor_PIS'
    end
    object qryitens_movimentacaoCOFINS: TStringField
      FieldName = 'COFINS'
      Size = 10
    end
    object qryitens_movimentacaoCST_COFINS: TStringField
      FieldName = 'CST_COFINS'
      Size = 10
    end
    object qryitens_movimentacaoBase_Reduzida_COFINS: TStringField
      FieldName = 'Base_Reduzida_COFINS'
      Size = 10
    end
    object qryitens_movimentacaoBase_Acrescida_COFINS: TStringField
      FieldName = 'Base_Acrescida_COFINS'
      Size = 10
    end
    object qryitens_movimentacaoBC_COFINS: TStringField
      FieldName = 'BC_COFINS'
      Size = 10
    end
    object qryitens_movimentacaoValor_COFINS: TFloatField
      FieldName = 'Valor_COFINS'
    end
    object qryitens_movimentacaoValor_Unitario: TFloatField
      FieldName = 'Valor_Unitario'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_movimentacaoQuantidade: TFloatField
      FieldName = 'Quantidade'
    end
    object qryitens_movimentacaoDesconto: TFloatField
      FieldName = 'Desconto'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_movimentacaoTipo_Desconto: TStringField
      FieldName = 'Tipo_Desconto'
      Size = 1
    end
    object qryitens_movimentacaoSub_Total: TFloatField
      FieldName = 'Sub_Total'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_movimentacaoSub_Total_Liquido: TFloatField
      FieldName = 'Sub_Total_Liquido'
    end
    object qryitens_movimentacaoUnidade: TStringField
      FieldName = 'Unidade'
      Size = 5
    end
    object qryitens_movimentacaoCodigo_Venda: TStringField
      FieldName = 'Codigo_Venda'
    end
    object qryitens_movimentacaoDescricao: TStringField
      FieldName = 'Descricao'
      Size = 50
    end
    object qryitens_movimentacaoEstoque: TFloatField
      FieldName = 'Estoque'
    end
    object qryitens_movimentacaoValor_Medio: TFloatField
      FieldName = 'Valor_Medio'
    end
  end
  object ds_qry_itens_venda: TDataSource
    DataSet = qryitens_movimentacao
    Left = 360
    Top = 280
  end
  object qrymovimentacao: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select MM.*, Cli.Nome_Nome_Fantasia, Fun.Nome from Movimentacao_' +
        'Manual MM'
      'inner join Cliente Cli on (Cli.Codigo = MM.Codigo_Cliente)'
      
        'inner join Funcionario Fun on (Fun.Codigo = MM.Codigo_Funcionari' +
        'o)')
    Left = 240
    Top = 280
    object qrymovimentacaoCodigo: TIntegerField
      FieldName = 'Codigo'
    end
    object qrymovimentacaoCodigo_Empresa: TIntegerField
      FieldName = 'Codigo_Empresa'
    end
    object qrymovimentacaoCodigo_Funcionario: TIntegerField
      FieldName = 'Codigo_Funcionario'
    end
    object qrymovimentacaoCodigo_Cliente: TIntegerField
      FieldName = 'Codigo_Cliente'
    end
    object qrymovimentacaoData_Emissao: TDateTimeField
      FieldName = 'Data_Emissao'
    end
    object qrymovimentacaoN_Ordem: TStringField
      FieldName = 'N_Ordem'
      Size = 10
    end
    object qrymovimentacaoModelo: TStringField
      FieldName = 'Modelo'
      Size = 10
    end
    object qrymovimentacaoN_Serie: TStringField
      FieldName = 'N_Serie'
      Size = 5
    end
    object qrymovimentacaoCaixa: TStringField
      FieldName = 'Caixa'
      Size = 5
    end
    object qrymovimentacaoNome_Nome_Fantasia: TStringField
      FieldName = 'Nome_Nome_Fantasia'
      Size = 50
    end
    object qrymovimentacaoNome: TStringField
      FieldName = 'Nome'
      Size = 50
    end
  end
