object FrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste: TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Teste
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'ADOQuery1.N_Documento'
      FooterBand = QRBand6
      Master = QuickRep1
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
      ...
      'left join Cheque Ch on (PLH.Codigo_Cheque = Ch.Codigo)'
        ...
        'where PLH.N_Documento = :Codigo and PLH.Data_Pagamento between :' +
        'DI and :DF')
    Left = 456
    Top = 88
