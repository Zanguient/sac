object FrmRel_Contagem_Estoque_Marca: TFrmRel_Contagem_Estoque_Marca
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 533
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'ADOQuery1.Codigo_Marca'
      FooterBand = QRBand1
      Master = QuickRep1
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select P.Codigo_Venda, P.Descricao, P.Estoque, M.Descricao as Ma' +
        'rca, P.Codigo_Marca, F.Nome_Fantasia from Produto P'
