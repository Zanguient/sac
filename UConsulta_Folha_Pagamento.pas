...
type
  TFrmConsulta_Folha_Pagamento = class(TForm)
    ...
    qryconsulta_folhaCodigo_Empresa: TIntegerField;
    ...
    qryconsulta_folhaComissao: TFloatField;
...
uses UChama_Funcionario, URel_Consulta_Folha_Pagamento, UDM, UChama_Empresa,
  UDeclaracao;
...
procedure TFrmConsulta_Folha_Pagamento.EdtCodigo_EmpresaKeyDown(Sender: TObject;
...
procedure TFrmConsulta_Folha_Pagamento.EdtEmpresaKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;

procedure TFrmConsulta_Folha_Pagamento.EdtFuncionarioKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;
